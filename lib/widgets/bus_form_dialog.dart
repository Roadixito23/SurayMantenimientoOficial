...
class BusFormDialog extends StatefulWidget {
  ...
  BusFormDialog({this.bus});

  @override
  _BusFormDialogState createState() => _BusFormDialogState();
}

class _BusFormDialogState extends State<BusFormDialog> with TickerProviderStateMixin {
