...
class AsignarRepuestoDialog extends StatefulWidget {
  final Bus bus;
  final Function()? onRepuestoAsignado;

  AsignarRepuestoDialog({
    required this.bus,
    this.onRepuestoAsignado,
  });

  @override
  _AsignarRepuestoDialogState createState() => _AsignarRepuestoDialogState();
}

class _AsignarRepuestoDialogState extends State<AsignarRepuestoDialog> {
