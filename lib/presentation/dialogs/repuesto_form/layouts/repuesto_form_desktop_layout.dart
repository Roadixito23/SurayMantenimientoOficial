...
/// Desktop layout del formulario de repuesto - AlertDialog tradicional
class RepuestoFormDesktopLayout extends StatefulWidget {
  final RepuestoCatalogo? repuesto;

  const RepuestoFormDesktopLayout({Key? key, this.repuesto}) : super(key: key);

  @override
  State<RepuestoFormDesktopLayout> createState() =>
      _RepuestoFormDesktopLayoutState();
}

class _RepuestoFormDesktopLayoutState extends State<RepuestoFormDesktopLayout> {
